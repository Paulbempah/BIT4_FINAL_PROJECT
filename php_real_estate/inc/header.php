...
<head>
    ...
    <meta name="author" content="Francis and Paul">
    

    <title>FRANKPAUL'S CONSULT -
        <?php echo $title ?>
    </title>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item <?php echo ($title == 'About Us') ? ' active' : ''; ?>">
                        ...
                        <?php if (isset($_SESSION['logged_in'])) {
                                // if logged in as a normal user, show Dreamproperty link
                                if ($_SESSION['role'] == "User") {
                                    echo "<li class='nav-item";
                                    echo ($title == 'Dreamproperty') ? ' active' : '';
                                    echo "'><a class='nav-link' href='Dreamproperty'><i class='icon icon-heart-empty'></i>Dreamproperty</a></li>";
