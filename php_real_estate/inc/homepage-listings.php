...
while($row = $results->fetch_assoc()) {
    ...
    $output .= "<a href='process/add-Dreamproperty.php?id=" . $row['property_id'] . "'><i class='icon homepage-heart icon-heart-empty shadow'>Add to Dreamproperty</i></a>";
    ...
    $output .= "<h1 class='listing-price'>GH₵".number_format($row["price"])."</h1>";
