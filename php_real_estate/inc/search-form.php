...
?>
    ...
    <form method="get" action="search.php">
        ...
        <div class="form-group search-separator">
            ...
            <option value="0">GH₵0</option>
            <option value="100000">GH₵100k</option>
            <option value="500000">GH₵500k</option>
            <option value="1000000">GH₵1M</option>
            <option value="2000000">GH₵2M</option>
            <option value="5000000">GH₵5M</option>
            <option value="10000000">GH₵10M+</option>
        ...
        <div class="form-group search-separator">
            ...
            <option value="2000000">GH₵2M</option>
            <option value="5000000">GH₵5M</option>
            <option selected value="10000000">GH₵10M+</option>
       </select>
        </div>
